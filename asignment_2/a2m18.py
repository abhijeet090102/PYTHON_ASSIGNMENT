...
health = input("Enter your health 'E' or 'P': ")
age = int (input("Enter your age between 25 to 35: "))
live_in = input("Enter , where do you live ? 'V' OR 'T': ")
gender = input("Enter 'M' or 'F': ")
if(gender=="M" and health=="E" and 25<age<=35 
   and live_in=="T"):
    print("Your premium is Rs . 4/thousand and policy ammount is cnnot exceed Rs.2 lakh")
elif(gender=="F" and 25<age<=35 and health=="E" and live_in =="T"):
    print("Your premium is Rs . 3/thousand and policy ammount is cnnot exceed Rs.1 lakh")
elif(gender=='M' and 25<= age <=35 and health=='P'  and live_in =='V'):
    print("Your premium is Rs . 6/thousand and policy ammount is cnnot exceed Rs.10,000")
else:
    print("Person cannot insured .")